...
log_name = 'Log-Session_20171203-184052';
...
figure(5), clf,
plot(agent_times_agg{1}, utilities3{1}(:,1), 'm'), hold on,
plot(agent_times_agg{1}, utilities3{1}(:,2), 'g'), grid on,
plot(agent_times_agg{1}, utilities3{1}(:,3), 'b'),
title('Utilities of agent 1 bids'), legend(agent_names{:}, 'Location', 'southwest'),

figure(6), clf,
plot(agent_times_agg{2}, utilities3{2}(:,1), 'm'), hold on,
plot(agent_times_agg{2}, utilities3{2}(:,2), 'g'), grid on,
plot(agent_times_agg{2}, utilities3{2}(:,3), 'b'),
title('Utilities of agent 2 bids'), legend(agent_names{:}, 'Location', 'southwest'),

figure(7), clf,
plot(agent_times_agg{3}, utilities3{3}(:,1), 'm'), hold on,
plot(agent_times_agg{3}, utilities3{3}(:,2), 'g'), grid on,
plot(agent_times_agg{3}, utilities3{3}(:,3), 'b'),
title('Utilities of agent 2 bids'), legend(agent_names{:}, 'Location', 'southwest'),